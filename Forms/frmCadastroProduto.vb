...
Public Class FrmCadastroProduto
    ...
    (nome, codigo_barras, descricao, categoria_id, fornecedor_nome, unidade_medida, quantidade, data_validade, marca)
    VALUES (@nome, @codigo, @desc, @cat, @forn, @unidade, @qtd, @validade, @marca)"
                Using cmdProduto As New SQLiteCommand(sqlProduto, conn)
                    ...
                    cmdProduto.Parameters.AddWithValue("@marca", txtMarcaProduto.Text)
    ...
    INSERT INTO Lotes 
    (produto_id, codigo_lote, quantidade, data_entrada, data_validade, marca)
    VALUES (@prod, @lote, @qtd, @entrada, @validade, @marca)"
                Using cmdLote As New SQLiteCommand(sqlLote, conn)
                    ...
                    cmdLote.Parameters.AddWithValue("@marca", txtMarcaProduto.Text)
    ...
    INSERT INTO Estoque 
    (produto_id, quantidade, lote, data_validade, marca)
    VALUES (@prod, @qtd, @lote, @validade, @marca)"
                Using cmdEstoque As New SQLiteCommand(sqlEstoque, conn)
                    ...
                    cmdEstoque.Parameters.AddWithValue("@marca", txtMarcaProduto.Text)
